    ...
    <span className={`brand-logo${light ? " brand-logo--light" : ""}`}>
      <span className="brand-mark" aria-hidden>
        <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="15" y="14" width="10" height="2" rx="1" fill="#15803d" fillOpacity="0.55" />
          <rect x="15" y="18" width="7" height="2" rx="1" fill="#15803d" fillOpacity="0.35" />
          {/* галочка — «резюме совпало с вакансией» */}
          <circle cx="27" cy="27" r="7.5" fill="#0f5132" />
