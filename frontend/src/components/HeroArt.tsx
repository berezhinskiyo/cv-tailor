...
export function HeroArt() {
  return (
    ...
    >
      ...
      <g className="ha-float ha-float-1">
        <circle cx="50" cy="300" r="28" fill="#fde8e8" />
        <text x="50" y="311" fontSize="24" textAnchor="middle">✍️</text>
      </g>

      {/* лист резюме с прогрессом совпадения */}
      <g>
        <rect x="118" y="86" width="244" height="208" rx="22" fill="url(#ha-card)" stroke="#dbe6fb" strokeWidth="2" />
        <rect x="142" y="112" width="120" height="14" rx="7" fill="#cfe0fb" />
        <rect x="142" y="136" width="78" height="10" rx="5" fill="#e6eefb" />

        {/* строки опыта */}
        <rect x="142" y="162" width="178" height="8" rx="4" fill="#eef3fb" />
        <rect x="142" y="178" width="150" height="8" rx="4" fill="#eef3fb" />

        {/* столбики совпадения навыков */}
        <g>
          <rect x="150" y="244" width="26" height="26" rx="6" fill="#cfe0fb" />
          <rect x="190" y="222" width="26" height="48" rx="6" fill="#9cc2f7" />
          <rect x="230" y="196" width="26" height="74" rx="6" fill="url(#ha-bar)" />
          <rect x="270" y="180" width="26" height="90" rx="6" fill="url(#ha-bar)" />
          <rect x="310" y="210" width="26" height="60" rx="6" fill="#9cc2f7" />
        </g>
        <path d="M163 248 L203 228 L243 204 L283 186 L323 216" stroke="#1d4ed8" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        <circle cx="283" cy="186" r="6" fill="#fff" stroke="#1d4ed8" strokeWidth="3" />
      </g>

      {/* бейдж «совпадение» */}
      <g className="ha-float ha-float-2">
        <circle cx="356" cy="146" r="26" fill="#16a34a" />
